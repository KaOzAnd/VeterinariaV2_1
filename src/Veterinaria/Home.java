    ...
    public static void main(String[] args) {
        ...
        do {
            menu = Integer.parseInt(JOptionPane.showInputDialog(null,
                    "<html><center><h1 style='font-family: Calibri; font-size: 36pt;'>Bienvenido"
                            + "<html><h2 style='font-family: Calibri; font-size: 20pt;'>Seleccione una opcion:"
            ...
            switch (menu) {
                case 1:// Inscripcion datos personas!!
                    do {
                        id = JOptionPane.showInputDialog(null, "Ingrese el numero de identificacion: ");
                        nombre = JOptionPane.showInputDialog(null,
                                "Ingrese el nombre de la personas con identificacion N°. " + id);
                        apellidos = JOptionPane.showInputDialog(null, "Ingrese el apellido de: " + nombre);
                ...
                case 2: // Inscripcion datos Mascota!!
                    do {
                        nombreM = JOptionPane.showInputDialog(null, "Ingrese el nombre de la mascota: ");
                        edadM = Integer.parseInt(
                                JOptionPane.showInputDialog(null, "Ingrese la edad de la mascota: " + nombreM));
                        ...
                        int selc = Integer.parseInt(JOptionPane.showInputDialog(null,
                                "Seleccione el dueno de la mascota : "
                                        + "\n Escriba el numero que corresponde al dueno de: " + nombreM + "\n"
                                        + cadena));
                        selc = selc - 1;
                ...
                case 3:// Inscripcion datos prodcuto!!
                    do {
                        nombreProducto = JOptionPane.showInputDialog(null, "Ingrese el nombre del producto o servicio");
                        valorProducto = Double.parseDouble(
                                JOptionPane.showInputDialog(null, "ingrese el valor del producto: " + nombreProducto));
                ...
                case 4:// Facturacion
                    do {
                        ...
                        for (int i = 0; i < datosProducto.size(); i++) {
                            ...
                            cadena2 += contador2 + "). " + datosProducto.get(i).getProducto() + " "
                                    + formatea.format(datosProducto.get(i).getValorProducto()) + "\n";
                        }
                        int selc1 = Integer.parseInt(JOptionPane.showInputDialog(null, "Seleccione el producto: \n"
                        ...
                        Factura Fac1 = new Factura(id, nombre, apellidos, nombreProducto, valorProducto);
